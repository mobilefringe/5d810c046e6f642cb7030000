    				...
    				<div class="row">
    				    <div class="col-md-12">
            				<div class="details_store_desc">
        				        ...
        				        <social-sharing :url="$root.shareURL('event_details',currentEvent.slug)" :title="currentEvent.title" :description="currentEvent.body" :quote="_.truncate(currentEvent.description, {'length': 99})" :twitter-user="$root.twitter_user" :media="currentEvent.image_url" inline-template >
